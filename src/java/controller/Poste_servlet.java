 ...
 * @author onian
 */
@WebServlet(name = "Poste_servlet", urlPatterns = {"/Poste_servlet"})
public class Poste_servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dep.getById(Integer.parseInt(request.getParameter("idDepartement")));
            Poste pos = new Poste(0, request.getParameter("titre"), Double.parseDouble(request.getParameter("salaire")), dep);
